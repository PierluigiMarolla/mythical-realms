...
export default function ChatSection() {
    ...
    return(
        <>
            <div className="relative container-home w-full md:w-1/2 bg-scroll border-2 border-black rounded-md bg-opacity-70 overflow-y-scroll scrollbar scrollbar-scroll">
